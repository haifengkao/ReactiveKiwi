...
Pod::Spec.new do |s|
  s.name             = "ReactiveKiwi"
  s.version          = "0.1.0"
  s.summary          = "A short description of ReactiveKiwi."
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = "https://github.com/<GITHUB_USERNAME>/ReactiveKiwi"
  # s.screenshots     = "www.example.com/screenshots_1", "www.example.com/screenshots_2"
  s.license          = 'MIT'
  s.author           = { "Hai Feng Kao" => "haifeng@cocoaspice.in" }
  s.source           = { :git => "https://github.com/<GITHUB_USERNAME>/ReactiveKiwi.git", :tag => s.version.to_s }
